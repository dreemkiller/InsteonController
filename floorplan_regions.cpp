...
RectangularRegion floorplan_regions[] = {
    ...
    { 178, 260, 337, 435, "Dining Room", 0, INSTEON_DINING_ROOM_ON_SIGNAL, INSTEON_DINING_ROOM_OFF_SIGNAL, false, { DINING_ROOM_INSTEON_ID, DEVICE_ID,  0         } },
    {  93, 178, 145, 254,     "Library", 1,     INSTEON_LIBRARY_ON_SIGNAL,     INSTEON_LIBRARY_OFF_SIGNAL, false, { LIBRARY_INSTEON_ID,     DEVICE_ID,  0         } },
};
